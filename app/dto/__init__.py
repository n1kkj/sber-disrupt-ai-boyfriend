...
__all__ = ['AuthResponse', 'LoginRequest', 'RegisterRequest', 'BoyfriendResponse', 'ChatCreateRequest', 'ChatResponse', 'MessageRequest', 'MessageResponse', 'TelegramClaimRequest', 'TelegramLinkResponse', 'UserResponse']
