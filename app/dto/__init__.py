...
__all__ = ['AuthResponse', 'LoginRequest', 'RegisterRequest', 'BoyfriendResponse', 'ChatCreateRequest', 'ChatResponse', 'MessageRequest', 'MessageResponse', 'MessageTaskResponse', 'TelegramClaimRequest', 'TelegramLinkResponse', 'UserResponse']
